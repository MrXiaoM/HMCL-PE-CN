package com.tungsten.hmclpe.sweetrice.launcher.view.spinner;
...
import com.tungsten.hmclpe.sweetrice.launcher.mod.curse.CurseAddon;
...
public class CategorySpinnerAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String c;
        int resId = context.getResources().getIdentifier((isCurse ? "curse_category_" : "modrinth_category_") + category.getId().replace("-","_"),"string","com.tungsten.hmclpe.sweetrice");
