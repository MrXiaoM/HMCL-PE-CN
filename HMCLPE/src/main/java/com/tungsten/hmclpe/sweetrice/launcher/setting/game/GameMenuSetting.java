...
import com.tungsten.hmclpe.sweetrice.launcher.setting.game.child.MenuFloatSetting;
import com.tungsten.hmclpe.sweetrice.launcher.setting.game.child.MenuViewSetting;
...
public class GameMenuSetting {
    ...
    public static GameMenuSetting getGameMenuSetting(){
        ...
        if (!new File(path).exists()){
            gameMenuSetting = new GameMenuSetting(new MenuFloatSetting(true,true,0.65f,0f),
