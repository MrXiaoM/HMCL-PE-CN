...
import com.tungsten.hmclpe.sweetrice.launcher.launch.boat.BoatMinecraftActivity;
import com.tungsten.hmclpe.sweetrice.launcher.launch.pojav.PojavMinecraftActivity;
import com.tungsten.hmclpe.sweetrice.launcher.setting.game.PrivateGameSetting;
import com.tungsten.hmclpe.sweetrice.launcher.view.list.MaxHeightRecyclerView;
        ...
        if (java && lib && login) {
            launchTask = new LaunchTask(activity, new LaunchTask.LaunchCallback() {
                ...
                public void onFinish(Vector<String> args) {
                    ...
                    Intent intent;
                    FileUtils.deleteDirectory("/data/user_de/0/com.tungsten.hmclpe.sweetrice/code_cache/");
