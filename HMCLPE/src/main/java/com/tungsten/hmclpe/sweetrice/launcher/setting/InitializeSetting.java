package com.tungsten.hmclpe.sweetrice.launcher.setting;

import android.app.Activity;
import android.content.Context;

import com.tungsten.hmclpe.sweetrice.R;
import com.tungsten.hmclpe.sweetrice.auth.authlibinjector.AuthlibInjectorServer;
import com.tungsten.hmclpe.sweetrice.launcher.MainActivity;
import com.tungsten.hmclpe.sweetrice.launcher.list.info.contents.ContentListBean;
import com.tungsten.hmclpe.sweetrice.manifest.AppManifest;
import com.tungsten.hmclpe.sweetrice.launcher.setting.game.child.BoatLauncherSetting;
import com.tungsten.hmclpe.sweetrice.launcher.setting.game.child.GameDirSetting;
import com.tungsten.hmclpe.sweetrice.launcher.setting.game.child.JavaSetting;
import com.tungsten.hmclpe.sweetrice.launcher.setting.game.child.PojavLauncherSetting;
import com.tungsten.hmclpe.sweetrice.launcher.setting.game.PrivateGameSetting;
import com.tungsten.hmclpe.sweetrice.launcher.setting.game.PublicGameSetting;
import com.tungsten.hmclpe.sweetrice.auth.Account;
import com.tungsten.hmclpe.sweetrice.launcher.setting.game.child.RamSetting;
import com.tungsten.hmclpe.sweetrice.launcher.setting.launcher.LauncherSetting;
import com.tungsten.hmclpe.sweetrice.launcher.setting.launcher.child.BackgroundSetting;
import com.tungsten.hmclpe.sweetrice.launcher.setting.launcher.child.SourceSetting;
...
public class InitializeSetting {
    ...
    public static LauncherSetting initializeLauncherSetting(){
        ...
        if (new File(AppManifest.SETTING_DIR + "/launcher_setting.json").exists()){
            ...
            launcherSetting = new LauncherSetting(AppManifest.DEFAULT_GAME_DIR,new SourceSetting(false,2,1),0,64,false,true,false,true,false,"DEFAULT",new BackgroundSetting(0,"",""),AppManifest.DEFAULT_CACHE_DIR);
