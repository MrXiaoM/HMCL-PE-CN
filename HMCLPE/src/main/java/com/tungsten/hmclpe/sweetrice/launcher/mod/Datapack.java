...
public class Datapack {
    ...
    public void loadFromZip() throws IOException {
        if (ZipTools.isFileExist(path.toString(),"datapacks")) {
            isMultiple = true;
            com.tungsten.hmclpe.sweetrice.utils.file.FileUtils.deleteDirectory(AppManifest.DEFAULT_CACHE_DIR + "/datapacks");
            com.tungsten.hmclpe.sweetrice.utils.file.FileUtils.createDirectory(AppManifest.DEFAULT_CACHE_DIR + "/datapacks");
